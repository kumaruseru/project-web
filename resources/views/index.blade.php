...
<header class="header-1">
    ...
    <div class="main-nav">
        <a href="{{ Route('login') }}" class="glow-on-hover">Log In</a>
        <a href="{{ Route('register') }}" class="glow-on-hover">Sign In</a>
    </div>
</header>
...
<div class="menu_product">
    <div>
        ...
        <button type="button" onclick="alert('Are you sure')">10.000</button>
    </div>
    <div>
